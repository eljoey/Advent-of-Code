...
const formatInput = (string) => {
    ...
    return [Number(nums[0]), Number(nums[1]), letter, password];
};

const validPasswords = (arr) => {
    let validCount = 0;
    for (let i = 0; i < arr.length; i++) {
        let [min, max, letter, password] = formatInput(arr[i]);
        let letterCount = false;
